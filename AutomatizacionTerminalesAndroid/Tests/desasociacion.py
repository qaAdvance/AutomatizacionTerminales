...
driver.find_element(By.XPATH, "//*[@id='painel-filter-container-parent']/button/ng-md-icon").click()
time.sleep(4)
...
driver.find_element(By.XPATH, "//*[@id='painel-filter-container-parent']/div[2]/md-card/ph-filter-form/ph-form/ng-form/div/div[3]/button[3]").click()
time.sleep(tiempo_entre_pasos)
'''Click en la terminal filtrada y en el icono de desasociar'''
driver.find_element(By.XPATH, "//*[@id='app-content']/ui-view/ui-view/div/ph-crud-maintenance/div/md-card/div[2]/ph-data-table/md-table-container/table/tbody/tr/td[1]").click()
time.sleep(tiempo_entre_pasos)
driver.find_element(By.CSS_SELECTOR, "#app-content > ui-view > ui-view > div > ph-crud-maintenance > div > md-card > div.maintenance-buttons.layout-gt-xs-row.layout-column > div.layout-wrap.layout-row.layout-align-start-start > button:nth-child(11)").click()
time.sleep(tiempo_entre_pasos)
driver.find_element(By.CSS_SELECTOR, "body > div.md-dialog-container.ng-scope > md-dialog > md-dialog-actions > button.md-primary.md-confirm-button.md-button.md-ink-ripple.md-PEDRO____IVO_content-theme").click()
time.sleep(tiempo_entre_pasos)
driver.find_element(By.CSS_SELECTOR, "body > div.md-dialog-container.ng-scope > md-dialog > md-dialog-actions > button").click()
time.sleep(10)
driver.close()
driver.quit()
